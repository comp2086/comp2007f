...
namespace RestaurantApp.Controllers
{
    public class ProductsController : Controller
    {
        ...
        {
			if (ProductType != "appetizer" || ProductType != "drink" ||
				ProductType != "maincourse" || ProductType != "dessert")
			{
				// return error view
			}
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<ActionResult> Edit([Bind(Include = "ProductId,ProductType,Name,ThumbNail,FullImage,ShortDesc,FullDesc,Price")] Product product)
        {
            if (ModelState.IsValid)
            {
